    ...
    <div ref={wrapperRef} className="relative">
      ...
      {currentItem && !isMobile && (
        <div className="absolute z-50 top-1/2 -translate-y-1/2 left-full ml-1 w-80 bg-gray-900 border-2 border-gray-700 rounded-lg shadow-2xl p-6">
          ...
          {/* HIỂN THỊ TỪNG DÒNG AFFIX RIÊNG BIỆT */}
      ...
      {/* MOBILE: Dính đáy */}
      {currentItem && isMobile && (
        <div className="fixed inset-x-0 bottom-0 z-50 p-4 bg-gradient-to-t from-black/95 via-black/70 to-transparent z-1000">
